...
qubit_indices=get_qubits_below_error_rate(backend.properties(),'x',10**(-3),27)
...
OT_creator = OverlappingTomographyBase(number_of_qubits=number_of_qubits,
                                    maximal_circuits_amount=maximal_circuits_number,
...
file_name_circuits = 'circuits_1200'
anf.save_results_pickle(dictionary_to_save=dictionary_to_save_jobs,
                                        directory=data_directory,
